...
## r-qps
The qps package is an implementation of the treatment effect estimation method and paper described above. This package provides functions for the two primary estimation steps -- QPS estimation and treatment effect estimation -- and is compatible with all major machine-learning libraries in R.
...
```bash
git clone https://github.com/factoryofthesun/r-qps
R CMD build qps
R CMD INSTALL qps_0.0.0.9000.tar.gz
```
...
## Vignettes
- [Introduction and Quickstart](https://github.com/factoryofthesun/r-qps/vignettes/qps-intro.Rmd)
- [Iris Simulation Example](https://github.com/factoryofthesun/r-qps/vignettes/qps-iris_sim.Rmd)
